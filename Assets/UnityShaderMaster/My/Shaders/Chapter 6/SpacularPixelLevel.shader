Shader "Unity_Shaders_Book/Chapter 6/SpacularPixelLevel"
{
    Properties {
    ...
    SubShader{
        Pass {
            ...
            fixed4 frag(v2f i) : SV_Target {
                ...
                fixed3 specular = _LightColor0.rgb * _Specular.rgb * pow(saturate(dot(viewDir, reflectDir)), _Gloss);   //  Phong模型高光反射方程
